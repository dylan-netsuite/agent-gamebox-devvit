...
export class LobbyBrowser extends Scene {
  ...
  create() {
    ...
    this.createActionButton(cx, 90, panelW, 52, '⚡', 'QUICK MATCH', 'Find an open game', 0x3498db, () => {
      void this.quickMatch();
    });

    this.createActionButton(cx, 160, panelW, 52, '➕', 'CREATE LOBBY', 'Start a new game room', 0x2ecc71, () => {
