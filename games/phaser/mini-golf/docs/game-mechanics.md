...
Surreal space-themed S-curve with three spinning gravity vortexes. Tee at bottom-left (100,700), cup at top-left (120,120). Two horizontal walls block the direct path — one at y=450 with a gap on the right, another at y=280 with a gap on the left — creating a mandatory S-curve. Three gravity wells are placed at each turn: Well A (170,530, r=55) guards the first turn, Well B (380,370, r=50) guards the second, Well C (300,170, r=45) guards the cup approach. Wells apply inverse-square attractive force within their outer radius; crossing the dead center (18% of radius) swallows the ball for a +1 penalty. Skilled players can slingshot around the outer edges to curve past walls. Small friction zone near the cup decelerates approach shots.
...
| Attraction Radius | Per-well (45-55 design units) |
| Dead Zone | 18% of attract radius — ball entering = swallowed (+1 penalty) |
| Strength | 0.0008–0.0012 (configurable per well) |
