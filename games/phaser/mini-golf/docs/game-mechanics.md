...
The final boss — a two-route choice-based design. Tee at top-center (250,90), cup at bottom-center (250,720). An open tee area (y:40-130) gives access to both routes via gaps in a divider wall.
**Route A — "The Dogleg Gauntlet" (left, x:30-280):** A two-leg zigzag corridor. Leg 1 (x:30-180, y:130-350) features a centrifuge windmill (speed 1.8, blade length 65). A dogleg at y:350 redirects the ball right into Leg 2 (x:120-280, y:350-620) with opposing crusher gates (tongues, speed 0.6) and bumpers. Leg 2 opens to the green at y:620. Requires 4-5 shots.
**Route B — "The Skinny Bridge" (right, x:360-400):** A direct 40-unit-wide bridge that drops straight down from the tee area divider. At y:400 the bridge ends over a massive water void. A moving bridge (width 80, speed 0.5) oscillates between y:400-610, carrying the ball across the water to the green. Nail the timing for a possible 2-3 shot completion — miss the bridge and the ball falls in water.
The green (x:30-470, y:620-760) features a gumdrop bumper, green bumper, and orange bumper for kinetic ricochet finishes near the cup. Composed from existing windmill, tongue, moving_bridge, bumper, and gumdrop_bumper mechanics.
