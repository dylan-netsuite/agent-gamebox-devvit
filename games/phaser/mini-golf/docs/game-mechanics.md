...
Three-corridor zigzag with bumpers at each turn and hazards in the path. Two horizontal dividers create three lanes: bottom (y:540→770), middle (y:300→540), and top (y:60→300). The lower divider at y=540 has a gap on the RIGHT (x:310→450); the upper divider at y=300 has a gap on the LEFT (x:50→190). Tee at x:100,y:700 (bottom-left), cup at x:400,y:150 (top-right). The ball zigzags RIGHT across the bottom lane, UP through the right gap, LEFT across the middle lane, UP through the left gap, then RIGHT across the top lane to the cup. Four gumdrop bumpers (restitution 1.8) at the corners and turns add excitement: bottom-right (410,700), right gap (400,470), left gap (100,370), and top-left corner (90,100). Two water hazards punish sloppy shots: a taffy pool (340,430) above the lower gap catches balls that overshoot, and a puddle (215,380) in the center of the middle corridor forces careful aim. Three ice cream slick zones (`ICE_FRICTION_AIR` 0.012) keep the ball gliding through the straightaway sections. Friction zones at the right U-turn, left U-turn, and around the cup provide rest areas where the ball decelerates to a controllable speed.
