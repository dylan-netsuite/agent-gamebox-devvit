...
Branching-path layout (x:80-420, y:60-740) with a center divider island (x:106-310, y:150-620) creating two routes. The tee (x:93), needle channel (x:80-106, 26px wide), and cup (x:93) are all on the same vertical line — a perfect straight shot from the tee threads the needle for a hole-in-one, but any angular error clips the wall and bounces into the graham cracker sand trap. The right path is 110px wide (x:310-420) with two 45-degree angled chocolate block corner bumpers at the top-right and bottom-right corners that ricochet the ball at 90 degrees, making it a safe two- or three-putt route. The center divider is a graham cracker sand trap — entering it dramatically increases friction air (0.15, 6x normal), stopping the ball dead.
