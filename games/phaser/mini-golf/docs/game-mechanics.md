...
Branching-path layout (x:80-420, y:60-740) with a center divider island (x:106-300, y:150-620) creating two routes. The left "needle" channel is only 26px wide (ball diameter 16px, ~5px clearance each side), aligned directly with the cup at x:93 — a perfect straight shot from the tee yields a hole-in-one, but any angular error clips the wall and bounces into the graham cracker sand trap. The right path is 120px wide with two gumdrop bumpers at the top-right and bottom-right corners that redirect the ball toward the cup, making it a safe two- or three-putt route. The center divider is a graham cracker sand trap — entering it dramatically increases friction air (0.15, 6x normal), stopping the ball dead. Tee is centered at x:250 so the player must commit to a direction.
