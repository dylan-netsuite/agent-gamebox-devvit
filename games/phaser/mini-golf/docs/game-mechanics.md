...
Full 18-hole course. Total par: 46.
...
### Hole 3: The Gumdrop Bumper Pinball (Par 2)
...
### Hole 4: The Graham Cracker Divide (Par 2)
...
### Hole 5: The Jawbreaker Wedge (Par 2)
...
### Hole 7: The Wafer Windmill (Par 2)
...
### Hole 8: The Teleportation Tunnels (Par 2)
...
### Hole 9: The Ice Cream Glide (Par 2)
...
### Hole 10: The Sour Tongues (Par 3)
...
### Hole 11: The Corkscrew Cannon (Par 2)
...
### Hole 15: The Cascading Plinko Board (Par 2)
...
### Hole 18: The Jawbreaker Centrifuge (Par 3)
...
### Hole 17: The Moving Island Sequence (Par 3)
...
### Hole 16: The Invisible Maze (Par 3)
...
| Shadow Radius | 55 design units |
| Speed | 0.4 cycles/second (~2.5s per full figure-eight) |
...
| Penalty | +1 stroke, ball reset to tee (Hole 13) or last shot position (default) |
...
| Exit Velocity | 60% of entry speed vertically upward, plus 30% of entry X velocity preserved horizontally |
...
| Rotation Speed | 1.8 rad/s (~3.5 seconds per full rotation) |
...
| Carry | When the ball overlaps the bridge bounds, its position is shifted by the bridge's per-frame Y delta (same pattern as moving islands). The ball's own velocity and physics are preserved — it rolls freely on the bridge surface. When the bridge reverses direction at endpoints, the smoothstep deceleration means the bridge slows while the ball retains its inertia, naturally sliding off. While on the bridge, the ball stays in 'simulating' state (not 'aiming'). |
