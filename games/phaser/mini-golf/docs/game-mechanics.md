...
The final boss. Tee at top-center (250,100), cup at bottom-center (250,710). An exceptionally narrow bridge corridor (x:195-305, just 110 units wide) crosses a massive water void. Three mechanic layers gate the path:
1. **The Centrifuge** (y=320): A 2-blade windmill spinning at speed 2.5 with 95-unit blade length spans nearly the entire corridor width. The ball must be timed to pass between the blades.
2. **The Crusher Gates** (y=480): Two opposing tongues thrust inward from both walls at speed 0.7, with opposite phases. They alternate between open and closed, requiring precise timing to slip through.
3. **The Kinetic Bumper Finish** (y=600-650): A central super bumper (red, r=14) flanked by two smaller bumpers (orange, r=10) can ricochet the ball toward the cup. High restitution creates satisfying kinetic feedback.
Water hazards cover both sides of the bridge (left: x:30 w:165, right: x:305 w:165), punishing any lateral deflection by the centrifuge or gates. No new obstacle types — composed entirely from existing windmill, tongue, and bumper mechanics.
